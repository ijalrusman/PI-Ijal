...
class Tata_tertib extends Super
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "tata_tertib";
        $this->active_id_menu = "tata_tertib";
        $this->nama_view      = "Tata Tertib";
        $this->status         = true; 
    ...
    function index(){
            ...
            **/
            ...
            /** Upload **/
            $this->crud->set_field_upload('file',$this->folder_upload);  
